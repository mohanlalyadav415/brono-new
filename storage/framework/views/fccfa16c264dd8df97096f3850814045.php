<?php $__env->startSection('title'); ?> Business Line List <?php $__env->stopSection(); ?>
...
<script type="text/javascript">   
    var table = $('#recordListing').DataTable({
        ...
        pageLength: 25,
        ajax: {
            url:'<?php echo e(url("/")); ?>/business-line-list', 
            dataType:"json",
            type:"POST",
            data: function (d) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\atgo\resources\views/budget/business_line.blade.php ENDPATH**/ ?>