...
<script type="text/javascript">  
	...
	$('#filterBtn').click(function() {
		...
		$.ajax({ 
			url:'<?php echo e(url("/")); ?>/execution-expense-summary-list',
			type: 'POST',
			data:{supplier_id:supplier_id,company_id:company_id,fromDate:fromDate,toDate:toDate,"_token": "<?php echo e(csrf_token()); ?>"},
			success: function(data) {  
...
$(document).ready(function(){
    $('#sendAllEmailBtn').on('click', function(){
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { allRowData: allRowData,sum:sum,supplier_id:supplier_id,company_id:company_id,fromDate:fromDate,toDate:toDate,"_token": "<?php echo e(csrf_token()); ?>" }, 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\atgo\resources\views/expenses/execution_expense_summary_list.blade.php ENDPATH**/ ?>