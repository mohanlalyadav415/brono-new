...
<script type="text/javascript">
    var table = $('#recordListing').DataTable({
        ...
        "ordering": false,
        ajax: {
            url:'<?php echo e(url("/")); ?>/executioncard', 
            dataType:"json",
            type:"POST",
            data: function (d) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\atgo\resources\views/expenses/executioncard.blade.php ENDPATH**/ ?>