<?php $__env->startSection('title'); ?> Expense Type List <?php $__env->stopSection(); ?>
...
<div id="loader-overlay">
    <div id="loader">
        <img src="<?php echo e(url('/')); ?>/images/spinner.gif" alt="Loading...">
        <p>Loading...</p>
    </div>
</div> 
<div class="row">
            ...
            <div class="card-body">  
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        href="<?php echo e(route('expense.type.export')); ?>">
...
<!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/css/select2.min.css">
    ...
    <script type="text/javascript">
        ...
        var table = $('#recordListing').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url:'<?php echo e(url("/")); ?>/expense-type-list', 
                dataType:"json",
                type:"POST",
                data: function (d) {
       ...
       /* $(".company_id, .expense_type_id").on('change',function(){ 
        ...
        $("table").on("change", ".allBtnHideShow", function() {
            ...
            if(confirm("Are you sure you want to check all ?")) {
                ...
                $.ajax({
                    url:'<?php echo e(url("/")); ?>/expense-type-list',
                    method:"POST", 
                    data:{company_id:company_id,expense_type_id:expense_type_id,checkboxVal : statusValue,action:'actionAllProject',"_token": "<?php echo e(csrf_token()); ?>"},
                    dataType:"json",
        ...
        //var allBtnHideShow = $('.allBtnHideShow', $(this).closest("td")).val();
            ...
            $.ajax({
                url:'<?php echo e(url("/")); ?>/get-project-list-by-company',
                method:"POST",
                data:{company_id:company_id,expense_type_id:associateID,"_token": "<?php echo e(csrf_token()); ?>"},
                dataType:"json",
                success:function(data){
                    //setProjectList 
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\atgo\resources\views/budget/expense_type_list.blade.php ENDPATH**/ ?>