        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form class="row g-3 needs-validation" method="post" action="<?php echo e(url('project_card_edit')); ?>/<?php echo e($getProject->project_id); ?>" enctype="multipart/form-data" novalidate>
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="name" id="name" value="<?php echo e($getProject->name); ?>" required=""> 
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <select class="form-control form-select" id="business_line_id" name="business_line_id" required="">
                                ...
                                <option value="<?php echo e($value->business_line_id); ?>" <?php echo e($value->business_line_id == $getProject->business_line_id ? 'selected' : ''); ?>><?php echo e($value->name); ?></option>
                        ...
                        <div class="col-md-3 position-relative">
                            <a href="<?php echo e(url('project_card_delete')); ?>/<?php echo e($getProject->project_id); ?>" onclick="return confirm('Are you sure you want to delete this record?')" class="btn btn-danger" ><i class="ri-delete-bin-line"></i> Delete</a>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\atgo\resources\views/budget/project_card_edit.blade.php ENDPATH**/ ?>