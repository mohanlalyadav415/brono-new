...
<?php $__env->startSection('title'); ?> Service Type List <?php $__env->stopSection(); ?>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        href="<?php echo e(route('service.export')); ?>?status=1">
...
<script type="text/javascript">   
    var table = $('#recordListing').DataTable({
        ...
        "ordering": false,
        ajax: {
            url:'<?php echo e(url("/")); ?>/servicelist', 
            dataType:"json",
            type:"POST",
            data: function (d) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\atgo\resources\views/expenses/servicelist.blade.php ENDPATH**/ ?>