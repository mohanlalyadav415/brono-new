...
<?php $__env->startSection('title'); ?> Normal Expense Card <?php $__env->stopSection(); ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1 text-center">NORMAL EXPENSE CARD</h4> 
            </div>

            <div class="card-body">
                <div class="live-preview">
                    <form class="row g-3 needs-validation" method="post" action="<?php echo e(url('normal-expense-card')); ?>" enctype="multipart/form-data" novalidate>
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-3 position-relative">
                            ...
                            <input type="number" class="form-control" name="amount" id="amount" value="<?php echo e(old('amount')); ?>" placeholder="Amount" min="1" required=""> 
                        ...
                        <div class="col-md-3 position-relative">
                            ...
                            <input type="number" class="form-control" name="qty" id="qty" value="<?php echo e(old('qty')); ?>" placeholder="Qty" min="1" required=""> 
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="purchase_order_code" id="purchase_order_code" value="<?php echo e(old('purchase_order_code')); ?>" placeholder="Purchase order" required=""> 
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <select class="form-control form-select" id="source_id" name="source_id" required="">
                                ...
                                <option value="<?php echo e($value->expense_source_id); ?>"><?php echo e($value->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\atgo\resources\views/expenses/normal_expense_card.blade.php ENDPATH**/ ?>