...
<?php $__env->startSection('title'); ?> Resources List <?php $__env->stopSection(); ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title text-center mb-0">RESOURCES LIST</h5>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        href="<?php echo e(route('resource.export')); ?>?status=1">
                        ...
                        <form method="post" id="recordForm" class="row g-3 needs-validation" novalidate>
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title"><i class="fa fa-plus"></i> Edit Resource</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <span style="color: red;" class="supplierError"> </span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="name" class="control-label">Resource Name</label>
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Resource Name" required>      
...
<script type="text/javascript">   
    var table = $('#recordListing').DataTable({
        ...
        "ordering": false,
        ajax: {
            url:'<?php echo e(url("/")); ?>/resourcelist', 
            dataType:"json",
            type:"POST",
            data: function (d) {
    ...
    $(document).on('change', '.status_check, .company_id', function () {
        ...
        var url = '<?php echo url('/'); ?>/resource-export?company_id=' + company_id + '&status=' + statusValue;
        console.log(url)
    ...
    $('#addRecord').click(function(){
        ...
        $('#recordForm')[0].reset();
        $('.modal-title').html("<i class='fa fa-plus'></i> Add Resource");
    ...
    $("#recordListing").on('click', '.update', function(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('#name').val(data.name); 
                $('.delete').attr('id',data.resource_id);  
                ...
                $('.modal-title').html("<i class='fa fa-plus'></i> Edit Resource");
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\atgo\resources\views/expenses/resourcelist.blade.php ENDPATH**/ ?>