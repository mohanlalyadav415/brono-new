            ...
            <div class="card-body">
                ...
                <div class="row"> 
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{url('/')}}/user_card" class="btn btn-primary" style="float: right;"><i class="ri-add-box-line"></i> New</a>
                    </div>
                </div> <br> 
                ...
                <div class="table-responsive">
                    <table id="UserTable" class="display table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            @if(isset($listUsers)) 
                            @foreach($listUsers as $index => $userData)
                            <tr>
                                ...
                                <td><div class="col-md-6 position-relative form-check form-switch form-switch-lg" style="margin-left: 50px;"><input type="checkbox" class="form-check-input" id="customSwitchsizelg" name="status" {{($userData->status==1 ? "checked" : "")}}></div></td>


                                <td>{{$userData->created_at}}</td> 
                                <td>{{$userData->register_by}}</td> 
                                <td>
                                    @if($index !=0)
                                    <a href="{{url('/').'/user_card_edit/'}}{{$userData->user_id}}" class="btn btn-primary"><i class="ri-edit-2-line"></i> Edit</a>

                                    <!-- <a href="{{url('/').'/user_card_delete/'}}{{$userData->user_id}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete ?')"><i class="ri-delete-bin-line"></i> Delete</a> -->
                                    @endif
                                </td> 
                            </tr>
                            @endforeach 
