...
@section('title') User Card @endsection
@section('content')
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form class="row g-3 needs-validation" method="post" action="{{url('user_card_edit')}}/{{$getUser->user_id}}" enctype="multipart/form-data" novalidate>
                        @csrf
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="dni" id="dni" value="{{$getUser->dni}}" required="" placeholder="11.111.111-1"> 
                            <span style="color: red;">@if($errors->has('dni'))
                                {{ $errors->first('dni')}} 
                                @endif
                            </span>
                        </div>
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="name" id="name" value="{{$getUser->name}}" required> 
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="last_name_1" value="{{$getUser->last_name_1}}" id="last_name_1" > 
                            <span style="color: red;">@if($errors->has('last_name_1'))
                                {{ $errors->first('last_name_1')}} 
                                @endif
                            </span>
                        </div>
                        <div class="col-md-3 position-relative"></div>
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="last_name_2" value="{{$getUser->last_name_2}}" id="last_name_1" > 
                            <span style="color: red;">@if($errors->has('last_name_2'))
                                {{ $errors->first('last_name_2')}} 
                                @endif
                            </span>
                        </div>
                        <div class="col-md-3 position-relative"></div>
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="email" class="form-control" name="email" value="{{$getUser->email}}" id="email" > 
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="phone" value="{{$getUser->phone}}" id="phone"> 
                        </div>
                        <div class="col-md-3 position-relative"></div>
                        ...
                        <div class="col-md-6 position-relative form-check form-switch form-switch-lg">
                            ...
                            <input type="checkbox" class="form-check-input" id="customSwitchsizelg" name="status" {{($getUser->status == 1 ? "checked" : "")}}>
                        </div> 
                        <div class="col-md-3 position-relative"></div>
                        ...
                        <div class="col-md-3 position-relative">
                            <a href="{{url('user_card_delete')}}/{{$getUser->user_id}}" onclick="return confirm('Are you sure you want to delete this record?')" class="btn btn-danger" ><i class="ri-delete-bin-line"></i> Delete</a>
                        </div>
...
<div class="popup cust_pop_cls">
    ...
    <div style="text-align: center;margin-top: 25px;" id="replaceDiv">
        ...
        <label><input type="checkbox" name="access_id[]"  class="checkbox" value="{{$value->access_id}}" id="ASDF_<?php echo $i; ?>"> {{$value->name}} </label>
        <?php $i++;?>
        @endforeach
        @endif
        <div class="btm-btns">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $/*("table").on("click", ".access-button1", function() {
            ...
            $.ajax({
                type:'POST',
                url:'{{url("get-user-access-module")}}',
                data:{'user_access_id':d,"_token": "{{ csrf_token() }}",},
