        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form class="row g-3 needs-validation" method="post" action="{{url('user_card')}}" enctype="multipart/form-data" novalidate>
                        @csrf
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="dni" id="dni" value="{{ old('dni') }}" placeholder="11.111.111-1" required=""> 
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="last_name_1" value="{{ old('last_name_1') }}" id="last_name_1" > 
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="last_name_2" value="{{ old('last_name_2') }}" id="last_name_2" > 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="text-align: -webkit-center;">
                <table>
                    ...
                    <tr>
                        <td><label><input type="checkbox" name="access_id" value="{{$value->access_id}}"> {{$value->name}} </label></td>
                    </tr>
                    @endforeach
                    @endif
                </table>
...
<div class="popup cust_pop_cls">
    ...
    @if(isset($getAccess))
    @foreach($getAccess as $value)
    <label><input type="checkbox" name="access_id[]"  class="checkbox" value="{{$value->access_id}}"> {{$value->name}} </label>
