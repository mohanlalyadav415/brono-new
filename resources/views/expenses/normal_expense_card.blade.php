...
@section('title') Normal Expense Card @endsection
@section('content')
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form class="row g-3 needs-validation" method="post" action="{{url('normal-expense-card')}}" enctype="multipart/form-data" novalidate>
                        @csrf
                        ...
                        <div class="col-md-3 position-relative">
                            ...
                            <input type="number" class="form-control" name="qty" id="qty" value="{{ old('qty') }}" placeholder="Qty" min="1" required=""> 
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="purchase_order_code" id="purchase_order_code" value="{{ old('purchase_order_code') }}" placeholder="Purchase order" required=""> 
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <select class="form-control form-select" id="source_id" name="source_id" required="">
                                ...
                                <option value="{{ $value->expense_source_id }}">{{ $value->name }}</option>
                                @endforeach
                                @endif
                            </select>
