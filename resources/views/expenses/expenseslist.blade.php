			...
			<div class="card-body">
				...
				<div class="row"> 
					...
					<div class="col-md-7">
						...
						href="{{ route('normal.expense.card') }}"><i class="ri-add-box-line"></i> New normal expense</a>

						<a class="float-right btn btn-xs btn-primary float-right btn-flat"
						href="{{ route('execution.expenses.card') }}"><i class="ri-add-box-line"></i> New execution expense</a>

						<a class="float-right btn btn-xs btn-primary float-right btn-flat accountExportBtn"
						href="{{ route('export.execution.expenses') }}">
						<i class="ri-export-fill"></i> Export</a>

						<a class="float-right btn btn-xs btn-primary float-right btn-flat softland"
						href="{{ route('export.softland') }}">
